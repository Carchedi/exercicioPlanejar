...
<?php
    ...
    //             if($fim < strtotime("22:00:00")){
    //                $total_noturno = $fim + strtotime("02:00:00");
    //             }else{
    ...
    //         if( $periodo_inicio == $periodo_fim){
    //             if($periodo_inicio == 0){
    //                 $total_diurno = (diferenca_tempo("22:00", $inicio)) + (diferenca_tempo($fim,"05:00"));
    //                 $total_noturno = strtotime("07:00:00");
    //             }else{
    //                 $total_diurno = strtotime("17:00:00");
    //                // $total_noturno = (diferenca_tempo("00:00"), $inicio) + (diferenca_tempo($fim, "22:00"));
    //             }
    //         }else{
    //             if($periodo_inicio == 0){
    //                 $total_diurno = diferenca_tempo("22:00", $inicio);;
    //                 $total_noturno = strtotime("02:00:00") + $final;
    //             }else{
    //                 $total_diurno = $final - strtotime("05:00:00");
    //                 $total_noturno = diferenca_tempo("29:00", $inicio);;
    //             }
    //         }
    //     }

    //     // echo "<br>".$inicio." -> ".$periodo_inicio."<br>".$fim." -> ".$periodo_fim;
    //     echo "<br><br> Resultado:<br>Total horas diurnas: ".$total_diurno.
    //          "<br>Total horas noturnas: ".$total_noturno;
